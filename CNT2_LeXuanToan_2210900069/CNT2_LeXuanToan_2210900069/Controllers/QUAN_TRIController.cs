...
using CNT2_LeXuanToan_2210900069.Models;

namespace CNT2_LeXuanToan_2210900069.Controllers
{
    public class QUAN_TRIController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaQuanTri,TenDangNhap,MatKhau,QuyenHan")] QUAN_TRI qUAN_TRI)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaQuanTri,TenDangNhap,MatKhau,QuyenHan")] QUAN_TRI qUAN_TRI)
        {
            if (ModelState.IsValid)
            {
